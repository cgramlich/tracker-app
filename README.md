...
Two repos (by design)
RepoVisibilityHoldsWhytracker-appPublicindex.html onlyGitHub Pages serves it freetracker-dataPrivatedata/*.jsonYour actual data, reached only by token
...
Follow SETUP.md for the step-by-step GitHub setup (repos, Pages, token).
Note: use the GitHub website, not the mobile app, to upload files.
Open the Pages URL on your phone, add it to the Home Screen, launch it.
Enter your repo details and connect.
Read MANUAL.md to learn the day-to-day flow.
